...
import { ACCENT, FIELD_BOXED, PAGE_TINT, btnBase } from "../lib/theme"
      ...
      >
        ...
        <div className="p-5 space-y-3">
          ...
          {/* Both numbers, before and after. The whole point of the dialog is
              ...
              to be visible. */}
          <div className="flex items-center gap-1.5 rounded-xl bg-white p-3 text-[11px] font-mono">
            {unit && (
              <RenderIcon
                name={unit.iconName}
                size={13}
            ...
            <span className="text-[#1E2A33]/60">
              This slot has <strong className="text-[#1E2A33]">{already}</strong>
              {" → will have "}
